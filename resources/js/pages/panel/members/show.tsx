...
export default function Show({ user, activities, sessions }: Props) {
                ...
                <Tabs defaultValue="activities" className="min-w-0 gap-4">
                    ...
                    >
                        <div className="flex flex-col gap-1">
                            ...
                            <p className="text-sm text-muted-foreground">
                                Üyeyle ilişkili son 20 denetim kaydı.
                            </p>
                        </div>
                        ...
                        {activityItems.length === 0 ? (
                            <Empty>
                                <EmptyHeader>
                                    ...
                                    <EmptyDescription>
                                        Bu üye için henüz kayıtlı etkinlik
                                        bulunmuyor.
                                    </EmptyDescription>
                                </EmptyHeader>
                            </Empty>
                    ...
                    >
                        <div className="flex flex-col gap-1">
                            ...
                            <p className="text-sm text-muted-foreground">
                                Üyenin son 20 giriş ve çıkış kaydı.
                            </p>
                        </div>
                        ...
                        {sessionItems.length === 0 ? (
                            <Empty>
                                <EmptyHeader>
                                    ...
                                    <EmptyDescription>
                                        Üye giriş yaptığında kayıtlar burada
                                        listelenir.
                                    </EmptyDescription>
                                </EmptyHeader>
                            </Empty>
            ...
            >
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            {currentUser.email} adresini bu üye için onaylamak
                            istediğinize emin misiniz? İşlem kaydedilecek ve
                            üyeye bilgilendirme e-postası gönderilecek.
                        </DialogDescription>
                    </DialogHeader>

                    <Form
                        {...MembersController.verifyEmail.form(currentUser)}
                        options={{
                            preserveScroll: true,
                        }}
                ...
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            ...
                            onaylanacak ve üyenin oturumları kapatılacak.
                        </DialogDescription>
                    </DialogHeader>

                    <Form
                        {...MembersController.requestEmailChange.form(
                            currentUser,
                        )}
                        options={{
                            preserveScroll: true,
            ...
            <Dialog open={statusDialogOpen} onOpenChange={setStatusDialogOpen}>
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Üyenin erişim durumunu active/passive olarak
                            güncelleyin. İşlem kaydedilecek ve üyeye
                            bilgilendirme e-postası gönderilecek.
                        </DialogDescription>
                    </DialogHeader>

                    <Form
                        {...MembersController.updateStatus.form(currentUser)}
                        options={{
                            preserveScroll: true,
                        }}

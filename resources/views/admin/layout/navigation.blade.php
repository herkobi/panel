<ul class="navbar-nav mx-md-auto">
    ...
    <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu">
            <a class="dropdown-item" href="{{ route('panel.tools.health') }}" title="Sistem Bilgisi">
                Sistem Bilgisi
            </a>
            <a class="dropdown-item" href="{{ route('panel.tools.accounts.auth.logs') }}" title="Oturum Kayıtları">
                Oturum Kayıtları
            </a>
            <a class="dropdown-item" href="{{ route('panel.tools.accounts.activities') }}" title="Kullanıcı İşlemleri">
                Kullanıcı İşlemleri
            </a>
            <a class="dropdown-item" href="{{ route('panel.tools.logs') }}" title="Sistem Kayıtları">
                Sistem Kayıtları
            </a>
    ...
    <li
        ...
        <div class="dropdown-menu">
            ...
            <a class="dropdown-item" href="{{ route('panel.settings.system') }}" title="Sistem Ayarları">
                Sistem Ayarları
            </a>
            <div class="dropend">
            ...
            <div class="dropend">
                ...
                <div class="dropdown-menu">
                    <a href="{{ route('panel.settings.payments') }}" title="Ödeme Yöntemleri" class="dropdown-item">
                        Ödeme Yöntemleri
                    </a>
                    <a href="{{ route('panel.settings.taxes') }}" title="Vergi Oranları" class="dropdown-item">
                        Vergi Oranları
                    </a>
                    <a href="{{ route('panel.settings.currencies') }}" title="Para Birimleri" class="dropdown-item">
                        Para Birimleri
                    </a>

...
@section('content')
    ...
    <div class="page-content">
        <div class="container">
            <div class="row">
                <div class="col-lg-3">
                    @include('admin.accounts.include.usercard')
                    @include('admin.accounts.include.usermenu')
                </div>
                <div class="col-lg-9">
                    <div class="card">
                            ...
                            <ul class="nav nav-tabs card-header-tabs">
                                <li class="nav-item">
                                    <a class="nav-link active" aria-current="true"
                                        href="{{ route('panel.account.detail', $user->id) }}" title="Kullanıcı İşlemleri">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('panel.account.authlogs', $user->id) }}"
                                ...
                                <table class="table table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="w-65">İşlem İçeriği</th>
                                        </tr>
                                    </thead>
                                    <tbody>

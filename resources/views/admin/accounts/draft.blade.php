                ...
                <div class="card h-100 border-0 mb-5">
                    <div class="card-header border-0 bg-white p-0 mb-3">
                        <div class="d-flex align-items-center justify-content-between w-100 border-bottom pb-2">
                            <div>
                                <h1 class="card-title mb-2">Duraklatılmış Kullanıcı Hesapları</h1>
                                <p class="small text-secondary mb-0">Durumu <span
                                        class="fw-bold text-danger">"Duraklatılmış"</span> olarak ayarlanmış kullanıcı
                                    hesapları
                                </p>
                            </div>
                        </div>
                            ...
                            <tbody>
                                @foreach ($users as $user)
                                    <tr>
                                        <td>
                                            <span
                                                class="badge bg-secondary">{{ AccountStatus::fromValue($user->status->value)?->title() }}</span>
                                        </td>

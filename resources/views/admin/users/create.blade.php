                ...
                <div class="col-lg-9">
                    <div class="card">
                        <div class="card-header">
                            <h1 class="card-title">Yeni Kullanıcı Ekle</h1>
                        </div>
                        <form action="{{ route('panel.user.store') }}" method="POST">
                            @csrf
                            <div class="card-body">
                                <div class="row">
                                    <label class="col-3 col-form-label">Kullanıcı Bilgileri</label>
                                    <div class="col">
                                        <div class="mb-2">
                                            <label class="col-form-label required">Kullanıcı Yetkisi</label>
                                            <div class="row">
                                                        ...
                                                        <div class="mb-1">
                                                            <label class="form-check">
                                                                <input class="form-check-input" name="role[]"
                                                                    ...
                                                                    {{ config('panel.adminrole') == $role->id ? 'checked' : '' }}>

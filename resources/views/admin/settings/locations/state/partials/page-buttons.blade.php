    ...
    <div class="btn-list">
        ...
        @if (auth()->user()->can('location.create'))
            @if (isset($second_link))
                <a href="{{ route($second_link, $country) }}" class="btn btn-primary d-none d-sm-inline-block">
                ...
                <a href="{{ route($second_link, $country) }}" class="btn btn-primary d-sm-none btn-icon"

<div class="dropdown-menu panel-dropdown shadow-none pb-0">
    ...
    <a class="dropdown-item {{ request()->routeIs('panel.tools.accounts.activities') ? 'active' : '' }}"
        href="{{ route('panel.tools.accounts.activities') }}" title="Ödeme Yöntemleri">
    ...
    <a class="dropdown-item {{ request()->routeIs('panel.tools.users.activities') ? 'active' : '' }}"
        href="{{ route('panel.tools.users.activities') }}" title="Vergi Bilgileri">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
            class="icon dropdown-item-icon">
            <path stroke="none" d="M0 0h24v24H0z" fill="none" />

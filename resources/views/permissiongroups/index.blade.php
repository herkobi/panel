                ...
                <div class="card-body">
                    <form action="{{ route('panel.permission.group.store') }}" method="post">
                        ...
                        <div class="mb-3 border-bottom pb-3">
                            <div class="row">
                                <label class="form-label col-md-4 fw-semibold mb-0" for="permission-group-name">Grup Adı</label>
                                <div class="col-md-8">
                                    <input type="text" class="form-control rounded-0 shadow-none form-control-sm" id="permission-group-name" name="name" value="{{ old('name') }}" placeholder="Grup Adı Örnek Rol Yönetimi, Kullanıcı Yönetimi" required autofocus>
                                </div>
                            </div>
                        </div>
                        <div class="mb-3 border-bottom pb-3">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <span class="small text-danger d-block">İzin grubunun hangi kullanıcı türü için kullanılacağını belirtmek için seçim yapınız</span>
                                </div>
                            </div>
                        </div>
                        <div class="mb-3 border-bottom pb-3">
                            <div class="row">
                                <label class="form-label col-md-4 fw-semibold mb-0" for="permission-group-name">Grup Açıklaması</label>
                                <div class="col-md-8">
                                    <input type="text" class="form-control rounded-0 shadow-none form-control-sm" id="permission-group-name" name="desc" value="{{ old('desc') }}" placeholder="Grup İle İlgili Kısa Açıklama" required>
                                </div>
                            </div>
                        </div>
                        <div class="mb-3">

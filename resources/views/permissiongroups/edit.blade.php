                    ...
                    <div class="card-body">
                        <form action="{{ route('panel.permission.group.update', $permissiongroup->id) }}" method="post">
                            ...
                            <div class="mb-3 border-bottom pb-3">
                                <div class="row">
                                    <label class="form-label col-md-4 fw-semibold" for="permission-group-name">Grup
                                        Adı</label>
                                    <div class="col-md-8">
                                        <input type="text" class="form-control rounded-0 shadow-none form-control-sm"
                                            id="permission-group-name" name="name"
                                            value="{{ $permissiongroup->name ? $permissiongroup->name : old('name') }}"
                                                ...
                                                <div class="col-md-6 mb-2">
                                                    <div class="form-check">
                                                        <input class="form-check-input rounded-0 shadow-none" type="radio"
                                                            id="permission-group-type-user"
                                                            {{ $permissiongroup->type->value == $type->value ? 'checked' : '' }}
                                                            disabled>
                            ...
                            <div class="mb-3 border-bottom pb-3">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" class="form-control rounded-0 shadow-none form-control-sm"
                                            id="permission-group-name" name="desc"
                                            value="{{ $permissiongroup->desc ? $permissiongroup->desc : old('desc') }}"
                                ...
                                <div class="row">
                                    <div class="offset-md-4 col-md-8">
                                        <div class="d-flex align-items-center justify-content-between w-100">
                                            ...
                                            @hasrole('Super Admin')
                                                <button type="button"
                                                    class="btn add-btn btn-danger btn-sm rounded-0 shadow-none"
                                                    onclick="event.preventDefault(); document.getElementById('destroy-form').submit();"><i
                                                        class="ri-delete-bin-2-line"></i> {{ __('Grubu Sil') }}</button>
                                            @endhasrole
                                        </div>
                                    </div>
                                </div>
                        ...
                        <form action="{{ route('panel.permission.group.destroy', $permissiongroup->id) }}" method="POST"
                            id="destroy-form">
                            @csrf
                        </form>
                    </div>

        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card rounded-0 shadow-sm border-0 mb-3">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('panel.store.admin.permissions', $user->id) }}"
                            autocomplete="off">
                            @csrf
                            ...
                            <div class="mb-3 border-bottom pb-3">
                                <div class="row">
                                    <label class="form-label col-md-2 fw-semibold mb-0" for="user-name">E-posta
                                        Adresi</label>
                            ...
                            <div class="mb-3 border-bottom pb-3">
                                <div class="row">
                                    <label class="form-label col-md-2 fw-semibold mb-0" for="user-roles">Tanımlı
                                        Yetkiler</label>
                            ...
                            <div class="mb-3 border-bottom pb-3">
                                <div class="row">
                                    <div class="col-md-2">
                                        ...
                                        <span class="d-block small text-danger">Özel izin tanımlarken tanımlı yetkiler
                                            dışında kalan izinlerden seçiniz</span>
                                    </div>
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="form-check form-switch">
                                                            <input class="form-check-input shadow-none" type="checkbox"
                                                                role="switch" id="select-all-{{ Str::slug('-', $key) }}"
                                                                onClick="setAllCheckboxes('{{ 'group-' . Str::slug('-', $key) }}', '{{ 'group-' . Str::slug('-', $key) . '-permissions' }}', this);">
                                                            <label class="form-check-label"
                                                                for="select-all-{{ Str::slug('-', $key) }}">Tümünü
                                                                Seç</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    @foreach ($permissions as $permissionId => $permission)
                                                        <div class="col-md-3">
                                                            <div class="form-check form-check-inline">
                                                                ...
                                                                <label class="form-check-label"
                                                                    for="role-permission-{{ $permissionId }}">{{ $permission['title'] }}</label>
                                                            </div>
                                                        </div>
                                                    @endforeach
                                                </div>

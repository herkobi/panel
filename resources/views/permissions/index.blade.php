    ...
    <div class="row">
        <div class="col-md-5">
            <div class="card rounded-0 shadow-sm border-0 mb-3">
                ...
                <div class="card-body">
                    <form action="{{ route('panel.permission.store') }}" method="post" autocomplete="off">
                        @csrf
                        <div id="repeater" class="mb-3 border-bottom pb-3">
                            <div class="row gx-1">
                                ...
                                <div class="col-md-3">
                                    <button type="button" id="createElement" class="btn btn-secondary btn-sm rounded-0 shadow-none align-self-buttom w-100" title="Satır Ekle"><i class="ri-add-line"></i> İzin Ekle</button>
                                </div>
                                <span class="offset-md-2 col-md-10 small text-danger">İzin ekle butonuna basarak gruba ait izinleri tanımlayınız</span>
                            </div>
                        </div>
                        <div class="mb-2">
                            <div class="row">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        @can('role-edit')
                                        <a href="{{ route('panel.permission.edit', $permission->id) }}" title="İzin Düzenle" class="text-decoration-none"><i class="ri-menu-3-fill"></i></a>
                                        @endcan
                                    </td>
                                </tr>
                                @endforeach
...
<div id="structure" style="display: none">
    <div class="row gx-1 mb-2">
        <div class="col-md-5"><input type="text" name="text[]" id="permission-text" class="form-control form-control-sm rounded-0 shadow-none" placeholder="İzin Açıklaması"></div>
        <div class="col-md-5"><input type="text" name="name[]" id="permission-name" class="form-control form-control-sm rounded-0 shadow-none" placeholder="İzin Adı"></div>
        <div class="col-md-2"><button type="button" class="btn btn-danger btn-sm border-0 rounded-0 shadow-none align-self-buttom w-100 removeElement" title="Kaldır"><i class="ri-delete-bin-line"></i></button></div>
    </div>
</div>
@endsection

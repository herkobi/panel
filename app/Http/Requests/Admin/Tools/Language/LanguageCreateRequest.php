...
class LanguageCreateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'name' => ['required', 'string', 'max:100', Rule::unique('languages', 'name')],
            'code' => ['required', 'string', 'size:2', Rule::unique('languages', 'code'), 'alpha', 'lowercase'],
            'regional_code' => ['required', 'string', 'size:5', Rule::unique('languages', 'regional_code')],

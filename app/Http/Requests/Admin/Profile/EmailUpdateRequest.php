...
class EmailUpdateRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'email_confirmation.email' => 'Lütfen geçerli bir onay e-posta adresi giriniz',
            'email_confirmation.max' => 'Lütfen daha kısa bir onay e-posta adresi giriniz',
            'email_confirmation.same' => 'Girmiş olduğunuz onay e-posta adresi aynı değil. Lütfen aynı e-posta adresini giriniz.',
        ];
    }
}
